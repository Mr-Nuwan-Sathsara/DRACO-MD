...
const response2 = await axios.get(url2)
const $$ = cheerio.load(response2.data)
const quality1 = $$("tbody:nth-child(1) > tr:nth-child(1) > td:nth-child(2) > strong").text()
const quality2 = $$("tbody:nth-child(1) > tr:nth-child(2) > td:nth-child(2) > strong").text()
const quality3 = $$("tbody:nth-child(1) > tr:nth-child(3) > td:nth-child(2) > strong").text()
const quality4 = $$("tbody:nth-child(1) > tr:nth-child(4) > td:nth-child(2) > strong").text()
